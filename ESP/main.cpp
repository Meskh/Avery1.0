...
// WebSocket server on port 81 - much faster than HTTP
WebSocketsServer webSocket = WebSocketsServer(81);

// IP address - will be set when AP is started
IPAddress localIP;
...
// Serve the optional HTML page for testing
void handleRoot() {
...
void handleStream() {
  ...
  while (client.connected()) {
    ...
    // Small delay to prevent flooding - faster refresh rate
    delay(20); // ~50 fps
  }
}
